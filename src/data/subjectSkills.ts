...
// 题型能力值接口
export interface QuestionTypeSkills {
  // 语文题型
...
// 默认初始值（所有题型能力值都是50）
export const DEFAULT_QUESTION_TYPE_SKILLS: QuestionTypeSkills = {
  modernReading1: 50,
  modernReading2: 50,
  classicalChinese: 50,
  ancientPoetry: 50,
...
// 学科能力值计算公式
export const calculateSubjectAbilities = (skills: QuestionTypeSkills): SubjectAbilities => {
  return {
...
// 题型显示名称
export const QUESTION_TYPE_NAMES: Record<keyof QuestionTypeSkills, string> = {
...
// 学科显示名称
export const SUBJECT_NAMES: Record<keyof SubjectAbilities, string> = {
  chinese: '语文',
  math: '数学',
  english: '英语',
  physics: '物理',
